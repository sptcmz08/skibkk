...
export default function RegisterPage() {
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'absolute', top: '15%', left: '15%', width: '300px', height: '300px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(254,240,138,0.1), transparent)', filter: 'blur(60px)', pointerEvents: 'none' }} />
