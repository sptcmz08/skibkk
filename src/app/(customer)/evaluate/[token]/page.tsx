...
const ratingColors = ['', '#f5576c', '#ffc107', '#38ef7d', '#FACC15']
            ...
            <div style={{ maxWidth: '540px', margin: '0 auto' }}>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                    ...
                    <div style={{
                        ...
                        margin: '0 auto 16px', boxShadow: '0 8px 32px rgba(250,204,21,0.3)',
                    }}>
                    ...
                    <div style={{ display: 'grid', gap: '14px' }}>
                        ...
                        <div>
                            ...
                            <div style={{
                                ...
                                background: 'rgba(250,204,21,0.1)', fontWeight: 700, fontSize: '16px',
